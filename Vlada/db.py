...
def generate_data():
    ...
    tables_data = {
        ...
        'Current_product': [
            ...
            (10, 1, 2, '2024-03-01', '2024-03-17', None),
            (5, 1, 2, '2024-03-02', '2024-03-17', None),
            (0, 1, 2, '2024-03-03', '2024-03-17', None)
        ],
        'Product_property': [
            (1, 'Товар 1', 'Категория 1', 'Характеристики', '2024-03-13', 100, 12340, None),
            (2, 'Товар 2', 'Категория 1', 'Характеристики', '2024-03-12', 100, 12341, None),
            (3, 'Товар 3', 'Категория 2', 'Характеристики', '2024-03-11', 200, 12342, None),
            ...
            (13, 'Товар 1', 'Категория 1', 'Характеристики', '2024-03-13', 100, 12340, None),
            (14, 'Товар 2', 'Категория 1', 'Характеристики', '2024-03-12', 100, 12341, None),
            (15, 'Товар 3', 'Категория 2', 'Характеристики', '2024-03-11', 100, 12342, None)
        ],
        'Operation_product': [
            (1, 1, 2, 10, 'Доставлен'),
            (1, 2, 2, 10, 'Доставлен'),
